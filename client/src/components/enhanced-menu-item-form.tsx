...
const menuItemFormSchema = z.object({
  ...
  availableBreakfast: z.boolean().default(false),
  availableLunch: z.boolean().default(false),
  availableSnacks: z.boolean().default(false),
  availableDinner: z.boolean().default(false),
      ...
      const loadExistingData = async () => {
        try {
          ...
          form.reset({
            ...
            availableBreakfast: menuItem.availableBreakfast ?? false,
            availableLunch: menuItem.availableLunch ?? false,
            availableSnacks: menuItem.availableSnacks ?? false,
            availableDinner: menuItem.availableDinner ?? false,
            availableAllDay: menuItem.availableAllDay ?? false,
