...
export const properties = pgTable("properties", {
  ...
  disableType: varchar("disable_type", { length: 50 }),
...
export const bookings = pgTable("bookings", {
  ...
  // No-Show fields
  noShowDate: timestamp("no_show_date"),
  noShowCharges: decimal("no_show_charges", { precision: 10, scale: 2 }).default("0"),
  ...
  advancePaymentMethod: varchar("advance_payment_method", { length: 20 }).default("cash"), // cash | upi | bank_transfer | card | online
...
export const leaseYearOverrides = pgTable("lease_year_overrides", {
  ...
  reason: text("reason"),
  remark: text("remark"),
  manualPaidOverride: decimal("manual_paid_override", { precision: 10, scale: 2 }),
  manualBalanceOverride: decimal("manual_balance_override", { precision: 10, scale: 2 }),
...
export const aiosellConfigurations = pgTable("aiosell_configurations", {
  ...
  pmsPassword: varchar("pms_password", { length: 255 }),
...
export type AiosellAuditReport = typeof aiosellAuditReports.$inferSelect;
