...
-   **Property Filtering**: 
    - **Managers & Kitchen**: Only see and manage data from their assigned property (rooms, dashboard stats, menu items, bookings, revenue)
    - **Property Enforcement**: Cannot create/modify/delete resources outside their assigned property
