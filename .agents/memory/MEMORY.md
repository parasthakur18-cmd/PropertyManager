...
- [Aiosell inventory sync behavior](aiosell-inventory-sync.md) — AioSell shows EXACTLY what Hostezee pushes (no self-deduction); all bookings including aiosell-sourced must count in push calculation
